...
class _TabFormState extends State<TabForm> with SingleTickerProviderStateMixin {
  ...
  // Fungsi untuk memilih tanggal kerusakan
  void _showDatePickerDamage() async {
    ...
    if (_selectedDate != null) {
      setState(
        () {
          _dateKerusakan.text =
              DateFormat('EE, d MMM yyyy').format(_selectedDate);
        },
      );
    }
  }
  ...
  void _showTimePickerDamage() async {
    ...
    if (_selectedTime != null) {
      setState(
        () {
          _timeKerusakan.text = _selectedTime.format(context);
        },
      );
    }
  }
