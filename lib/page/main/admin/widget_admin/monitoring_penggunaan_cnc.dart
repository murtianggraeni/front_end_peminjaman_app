...
class monitoringPenggunaanCnc extends StatelessWidget {
  ...
  //   CurrentMonitoringController(machineType: MachineType.CNC),
  // );
  ...
  //               maxX: (weeklyData.length - 1).toDouble(),
  //               minY: 0,
  //               maxY: 30, // Disesuaikan dengan data maksimal
  //               lineBarsData: [
  //                 // Line untuk durasi
  //                 LineChartBarData(
  //                   spots: weeklyData.asMap().entries.map((entry) {
  ...
  // double _convertDurationToMinutes(double hours) {
  //   return hours * 60; // Konversi jam ke menit
  // }
  ...
  //       show: true,
  //       drawVerticalLine: false,
  //       horizontalInterval: 5, // Interval 5 menit
  //       getDrawingHorizontalLine: (value) {
  //         return FlLine(
  //           color: const Color(0xffe7e8ec),
  //           strokeWidth: 1,
  ...
  //           getTitlesWidget: (value, meta) {
  //             return Text(
  //               '${value.toInt()} min', // Tampilkan label dalam menit
  //               style: GoogleFonts.inter(
  //                 color: const Color(0xff68737d),
  //                 fontSize: 12,
  //               ),
  ...
  //     maxY: _getMaxY(weeklyData),
  //     lineBarsData: [
  //       // Line untuk durasi dalam menit
  //       LineChartBarData(
  //         spots: weeklyData.asMap().entries.map((entry) {
  //           return FlSpot(
  //             entry.key.toDouble(),
  //             _convertDurationToMinutes(entry.value.stats.totalDuration),
  //           );
  //         }).toList(),
  //         isCurved: true,
  //         color: const Color(0xFFF13159),
  ...
  //         _convertDurationToMinutes(day.stats.totalDuration);
  //     if (durationInMinutes > maxDurationInMinutes) {
  //       maxDurationInMinutes = durationInMinutes;
  //     }
  //     if (day.stats.userCount > maxUsers) {
  //       maxUsers = day.stats.userCount.toDouble();
  //     }
  ...
  //   return max(maxDurationInMinutes, maxUsers) * 1.2; // Add 20% padding
  // }
  ...
  //     children: [
  //       _buildLegendItem(
  //         "Durasi (menit)", // Ubah label menjadi menit
  //         const Color(0xFFF13159),
  //       ),
  //       const SizedBox(width: 24.0),
  //       _buildLegendItem(
