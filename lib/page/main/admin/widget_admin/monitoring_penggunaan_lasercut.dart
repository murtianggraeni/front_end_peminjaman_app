...
class monitoringPenggunaanLasercut extends StatelessWidget {
  monitoringPenggunaanLasercut({Key? key}) : super(key: key);

  final MonitoringController _controller =
      Get.put(MonitoringController(MachineType.LaserCutting), tag: 'laser');

  // final CurrentMonitoringController _currentController = Get.put(
  //     CurrentMonitoringController(machineType: MachineType.LaserCutting),
  //     tag: 'laser');
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Column(
                          ...
                          children: [
                            Text(
                              "Monitoring Penggunaan Mesin Laser Cutting",
