...
@override
  ...
  Widget _buildDataTable2(BoxConstraints constraints) {
    return Container(
      height: constraints.maxHeight * 0.2, // Adjust this value as needed
      child: DataTable2(
        columnSpacing: 12,
        horizontalMargin: 12,
        minWidth: 600,
        columns: [
          DataColumn2(
            label: Text('Nama', style: GoogleFonts.inter(fontWeight: FontWeight.bold,)),
            size: ColumnSize.L,
          ),
          DataColumn2(
            label: Text('Kategori', style: GoogleFonts.inter(fontWeight: FontWeight.bold)),
            size: ColumnSize.M,
          ),
          DataColumn2(
            label: Text('Detail Keperluan', style: GoogleFonts.inter(fontWeight: FontWeight.bold)),
            size: ColumnSize.L,
          ),
          DataColumn2(
            label: Text('Durasi', style: GoogleFonts.inter(fontWeight: FontWeight.bold)),
            size: ColumnSize.S,
          ),
        ],
