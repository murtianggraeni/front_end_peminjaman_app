...
class detailPagePrinting extends StatefulWidget {
  detailPagePrinting({Key? key}) : super(key: key);

  @override
  State<detailPagePrinting> createState() => _detailPagePrintingState();
}

class _detailPagePrintingState extends State<detailPagePrinting> {
  ...
  void initState() {
    super.initState();
    _controller = Get.find<PeminjamanUserAllbyAdminController>(tag: 'printing');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Monitoring 3D Printing"),
      ),
      body: SafeArea(
        child: Container(
